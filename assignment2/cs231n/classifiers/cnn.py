...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        self.params['W2'] = weight_scale * \
            np.random.randn(int(F * H / 2 * W / 2), hidden_dim)
    ...
    def loss(self, X, y=None):
        ...
        aff_relu_out, aff_relu_cache = affine_relu_forward(
            conv_relu_pool_out, W2, b2)
        ...
        daffine, grads['W3'], grads['b3'] = affine_backward(dscore, aff_cache)
        dpool, grads['W2'], grads['b2'] = affine_relu_backward(
            daffine, aff_relu_cache)
        dx, grads['W1'], grads['b1'] = conv_relu_pool_backward(
            dpool, conv_relu_pool_cache)
